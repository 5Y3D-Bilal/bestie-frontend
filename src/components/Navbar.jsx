...
function Navbar() {
  ...
  return (
    <>
      <nav className="py-1 bg-white max-w-6xl mx-5 lg:mx-auto z-50">
      ...
      {showNavbar ? (
        <nav
          className={`py-1 bg-white top-0 sticky z-50 ${
            showNavbar ? "downD" : "upD"
                  ...
                  {navLinks.map((item) => {
                    ...
                    return (
                      <Link
                        key={item.name}
                        className={`cursor-pointer ${
                          isActive ? "text-[#9748FF]" : "text-black"
                        } font-semibold leading-4`}
                        href={item.href}
                      >
                        {item.name}
